...
export default class ChildCompoment extends Component {
  ...
  shouldComponentUpdate(newProps, newState) {
    ...
    //return về true thì render được chạy còn return về false thì render không được chạy
  ...
  render() {
    console.log("render ChildCopoment");
    return (
      <div>
